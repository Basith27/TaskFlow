...
namespace taskflowbackend.Migrations
{
    ...
    [Migration("20250806180950_InitialSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Models.BoardUser", b =>
                {
            ...
            modelBuilder.Entity("TaskFlow.Models.Card", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskFlow.Models.CardUser", b =>
                {
            ...
            modelBuilder.Entity("TaskFlow.Models.List", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskFlow.Models.Board", b =>
                {
                    b.HasOne("TaskFlow.Models.Workspace", "Workspace")
                        .WithMany("Boards")
            ...
            modelBuilder.Entity("TaskFlow.Models.Card", b =>
                {
                    b.HasOne("TaskFlow.Models.List", "List")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("TaskFlow.Models.CardUser", b =>
                {
                    b.HasOne("TaskFlow.Models.Card", "Card")
                        .WithMany("CardUsers")
